...
<body>
    ...
    <table class="content">
        <tr>
            ...
            <td class="value">{{ $donor->gender }}</td>
        </tr>
        <tr>
            <td class="label">Alamat rumah</td>
            <td class="value">{{ $donor->address }}</td>
            <td class="value">No. {{ $donor->house_number }} - RT/RW {{ $donor->rt_rw }}</td>
        </tr>
        <tr>
            <td class="label">Kelurahan</td>
            <td class="value">{{ $donor->village }}</td>
            <td class="value">Kecamatan {{ $donor->district }}</td>
        </tr>
        <tr>
            <td class="label">Wilayah</td>
            <td class="value">{{ $donor->region }}</td>
            <td class="value">Telepon {{ $donor->phone }}</td>
        </tr>
        <tr>
